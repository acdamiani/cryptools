...
const title = `ASCII to Hexadecimal Converter - Cryptools`;
const description = `ASCII/Unicode text to hexadecimal converter.`;
const og: OpenGraph = { url: `https://cryptools.dev/converters/ascii-to-hex` };
